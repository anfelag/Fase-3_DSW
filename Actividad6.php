			...
			<center>
                ...
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                  ACTIVIDAD 6 
                    ...
                    <hr>
					<iframe id="actividadIF" src="//es.educaplay.com/es/recursoseducativos/4083040/html5/conociendo_mysql.htm"width="100%" height="690" frameborder="0"></iframe>
                    </br>
                <div class="col-md-12">
                        </br>
                        Navas, C. Conociendo MySql. Recuperado de: <a href="https://es.educaplay.com/recursos-educativos/4083040-conociendo_mysql.html">https://es.educaplay.com/recursos-educativos/4083040-conociendo_mysql.html</a></div>
              </div>
                </div>
            </div>
