			...
			<center>
                ...
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                  ACTIVIDAD 3 
                    ...
                    <hr>
					<iframe id="actividadIF" src="//es.educaplay.com/es/recursoseducativos/4079707/html5/crucigrama_mysql.htm"width="100%" height="690" frameborder="0"></iframe>
                    </br>
                <div class="col-md-12">
                  <p>Gomez, Q. C. Crucigrama Mysql. Recuperado de: <a href="https://es.educaplay.com/recursos-educativos/4079707-crucigrama_mysql.html">https://es.educaplay.com/recursos-educativos/4079707-crucigrama_mysql.html</a> </p>
                </div>
              </div>
                </div>
            </div>
