			...
			<center>
                ...
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                  ACTIVIDAD 2 
                    ...
                    <hr>
					<iframe id="actividadIF" src="//es.educaplay.com/es/recursoseducativos/786198/html5/sopa_de_letras_html.htm" width="100%" height="690" frameborder="0"></iframe>
                    </br>
                <div class="col-md-12">
                  <p>Güiza, L. M. SOPA DE LETRAS HTML. Recuperado de: <a href="https://es.educaplay.com/recursos-educativos/786198-sopa_de_letras_html.html">https://es.educaplay.com/recursos-educativos/786198-sopa_de_letras_html.html</a></p>
                </div>
              </div>
                </div>
            </div>
