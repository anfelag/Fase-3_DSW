			...
			<center>
                ...
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                  ACTIVIDAD 1
                    ...
                    <hr>
					<iframe src="https://www.educaplay.com/es/recursoseducativos/2168187/html5/etiquetas_web.htm" width="100%" height="690" frameborder="0"></iframe>
                    </br>
                <div class="col-md-12">
                  <p>Rodriguez, A. E. Etiquetas Web. Recuperado de: <a href="https://es.educaplay.com/recursos-educativos/2168187-etiquetas_web.html">https://es.educaplay.com/recursos-educativos/2168187-etiquetas_web.html</a> </p>
                </div>
              </div>
                </div>
            </div>
