			...
			<center>
                ...
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                  ACTIVIDAD 4 
                    ...
                    <hr>
					<iframe id="actividadIF" src="//es.educaplay.com/es/recursoseducativos/2651922/html5/vinculacion_base_de_datos_php.htm"width="100%" height="690" frameborder="0"></iframe>
                    </br>
                <div class="col-md-12">
                  <p>Castro, G. D. Vinculación base de datos PHP.  Recuperado de: <a href="https://es.educaplay.com/recursos-educativos/2651922-vinculacion_base_de_datos_php.html">https://es.educaplay.com/recursos-educativos/2651922-vinculacion_base_de_datos_php.html</a> </p>
                </div>
              </div>
                </div>
            </div>
